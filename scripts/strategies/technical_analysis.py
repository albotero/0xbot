...
def technical_analysis(exchange: ExchangeInterface, market: str) -> None:
    """Generate buy/sell signals for the given indicators

    Parameters
    ----------
    exchange: Interface to Exchange's API
